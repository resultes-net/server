...
Revision ID: d83096fbe3d6
Revises: 
Create Date: 2025-05-11 15:25:54.467819
...
def upgrade() -> None:
    ...
    sa.Column('state', sa.Enum('WAITING', 'RUNNING', 'DONE', name='variationstate'), nullable=False),
